...
public class StatActivity extends ActionBarActivity {
    ...
    private long amountOfRecords = 0;

    private final Date selectedDate = new Date();

    private Map<String, ArrayList<LatLng>> listOfAreas = new HashMap<>();

    private String getDateTime(final Date inputDate) {
    ...
    public void ListDialog(final int Location) {
        ...
        ListView list = new ListView(StatActivity.this);
    ...
    public void TimeBetweenZones(View v) {
        ...
        h = new Handler() {
            public void handleMessage(android.os.Message msg) {
                textView.setText(GetTimeBetweenZones(firstString, secondString));
            }
    ...
    public String GetTimeBetweenZones(String FirstZone, String SecondZone) {
        textView = (TextView) findViewById(R.id.DataBaseString);
    ...
    public void ShowStatMethod(View v) {
        ...
        Intent myIntent = new Intent(StatActivity.this, Diagram.class);
        myIntent.putExtra("hashMap", StatTable); //Optional parameters
        myIntent.putExtra("StatSince", SinceDateString);
        StatActivity.this.startActivity(myIntent);
    }
    ...
    public class GetDataProgress extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            if (c.moveToFirst()) {
                ...
                int longColIndex = c.getColumnIndex("Longitude");
                do {
                    Date time = new Date(c.getLong(created_atColIndex));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DataBase(StatActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent myIntent = new Intent(StatActivity.this, SettingsActivity.class);
            StatActivity.this.startActivity(myIntent);
            return true;
        }
